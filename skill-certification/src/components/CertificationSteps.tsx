...
//       description: "Sign up for the certification program through our online portal.",
...
//       description: "Work through a series of interactive online learning modules at your own pace.",
//       image: "/api/placeholder/300/200",
//       duration: "2-4 weeks",
...
//       description: "Complete hands-on projects to apply your new skills in real-world scenarios.",
//       image: "/api/placeholder/300/200",
//       duration: "3-5 weeks",
...
//       description: "Take a comprehensive exam to demonstrate your mastery of the course material.",
//       image: "/api/placeholder/300/200",
//       duration: "1 day",
//       bgColor: "bg-red-600",
//     },
...
//   return (
//     <div className="flex flex-col md:flex-row bg-indigo-900 p-8 h-screen">
//       <div className="md:w-1/3 flex flex-col justify-between pr-8">
//         <div>
//           <h1 className="text-4xl font-bold text-white mb-4">
//             Steps to Complete Your Certification
//           </h1>
//           <p className="text-gray-300 mb-4">Follow these steps to earn your certificate</p>
//           <button className="bg-white text-black px-4 py-2 rounded mb-4">
//             Start Your Journey →
//           </button>
//           <div className="flex justify-between items-center">
//             <button onClick={() => swiper?.slidePrev()} className="text-white">
//               <ChevronLeft size={24} />
//             </button>
...
//               ></div>
//             </div>
//             <button onClick={() => swiper?.slideNext()} className="text-white">
...
//               <div className={`${step.bgColor} p-6 rounded-lg h-full flex flex-col`}>
//                 <img src={step.image} alt={step.title} className="w-full h-48 object-cover rounded mb-4" />
